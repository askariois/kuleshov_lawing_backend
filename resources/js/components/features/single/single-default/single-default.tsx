...
export default function SingleDefault() {
   ...
   const returnUrl = `/images/${projectId}?mime_type=&status=${image.status}`;
         ...
         case 'raw':
            return (<div className="mt-6 ">
               <div className="flex justify-between gap-1.5 mb-1.5">
                  ...
                  <Button variant="secondary" size={'full'} className='text-[18px] font-semibold hover:bg-primary hover:text-white' onClick={() => onImage('process')}>
                     На поиск
                  </Button>
               </div>
            </div>);
